package cn.itsource.aigou.jedis;
...
public final class RedisUtils {
	...
	static {
		try {
			...
			jedisPool = new JedisPool(config, GlobalSetting.get(GlobalSettingNames.REDIS_HOST),
					Integer.parseInt(GlobalSetting.get(GlobalSettingNames.REDIS_PORT)), TIMEOUT,
					GlobalSetting.get(GlobalSettingNames.REDIS_AUTH));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
