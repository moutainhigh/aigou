...
<%@include file="/WEB-INF/views/common-link.jsp" %>
	...
	<body class="pace-done">
							...
							<dl class="attr">
								...
								<dd class="dd">
									<ul>
										...
										<li class="goods-spec-item" data-spec-id="${attrName}" data-is-default="0">
											<a href="javascript:void(0);" title="${attrName}">
												<span class="value-label">${attrName}</span>
											</a>
										</li>
										</c:forEach>
									</ul>
		...
		<!-- <input type="hidden">
		<xxx id="data" style="display:none;"></xxx> 
		$('body').data('content','xxxxxxx'); -->
